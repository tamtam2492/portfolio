...
const clients = [
  {
    ...
    projects: [
      ...
      },
      {
        ...
        solution: { en: "Built an automated reporting pipeline: agents submit daily data via Telegram bot → n8n processes and aggregates it automatically into a structured Excel backbone tracking ACH Target, Recovery Rate, and Gap Analysis across all cities. Eliminated manual compilation entirely.", id: "Membangun pipeline pelaporan otomatis: agen mengirimkan data harian via bot Telegram → n8n memproses dan mengagregasi otomatis ke backbone Excel terstruktur yang melacak ACH Target, Recovery Rate, dan Gap Analysis di semua kota. Kompilasi manual dihilangkan sepenuhnya." },
        roi: { en: "Daily reporting time cut from a full working day to near-instant automated aggregation — eliminating 8 hours/day of coordination overhead. Leadership time fully shifted from data compilation to agent coaching and decision-making.", id: "Waktu pelaporan harian dipangkas dari seharian penuh menjadi agregasi otomatis yang hampir instan — menghilangkan 8 jam/hari overhead koordinasi. Waktu kepemimpinan sepenuhnya beralih dari kompilasi data ke coaching agen dan pengambilan keputusan." },
        tools: ["n8n", "Telegram Bot", "Advanced Excel", "SUMIFS", "XLOOKUP", "Google Sheets"],
