    ...
    projects: [
      {
        ...
        solution: { en: "Built an end-to-end n8n workflow: agent sends a receipt photo to Telegram, AI/OCR extracts Channel, Amount, Admin Fee, and Date per-field, validates each individually, appends to Google Sheets, and replies with a structured confirmation — or tells the agent exactly which field failed to read.", id: "Membangun workflow n8n end-to-end: agen kirim foto bukti ke Telegram, AI/OCR mengekstrak Channel, Nominal, Biaya Admin, dan Tanggal per-field, memvalidasi masing-masing, menambahkan ke Google Sheets, dan membalas dengan konfirmasi terstruktur — atau memberi tahu agen persis field mana yang gagal terbaca." },
