    ...
    projects: [
      {
        ...
        tools: ["Node.js", "Supabase", "Groq AI / OCR", "Vercel", "AWS Lambda", "bcrypt", "REST API", "HTML/CSS/JS"],
    ...
    projects: [
      {
        ...
        roi: { en: "Fully digitized operations. Every sale is recorded, stock is tracked automatically, receipts print instantly via Bluetooth, and sales data is exportable anytime. Deployed live on Vercel at kasir-nie-buket.vercel.app.", id: "Operasional sepenuhnya terdigitalisasi. Setiap penjualan tercatat, stok dilacak otomatis, struk tercetak seketika via Bluetooth, dan data penjualan dapat diekspor kapan saja. Live di Vercel: kasir-nie-buket.vercel.app." },
